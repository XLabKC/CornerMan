...
(function() {
   ...
   var makeTemplateValueAccessor = function(element, valueAccessor, viewModel, asChildren) {
      assertArgs(arguments, Node, Function, anything(), Boolean);
      ...
      assertOfType(value, [String, ViewModel, arrayOf(ViewModel), Object]);
      var child = null;
      var children = null;
      ...
      if (insist.isOfType(value, [ViewModel, arrayOf(ViewModel)])) {
